...
class UserModel extends Model
{
    ...
    'date_created', 'date_updated', 'height','weight','age','position','protection','relationship','bodyColor','bodyShape','hair','publish','vip','superAdmin','public','friends','fun'];
    ...
    public function registerByPhone($array) {
        ...
        $data = [
            ...
            'phone'         => $array['ph'],
            'fullname'    => $array['fn'],
            'image'         => $array['img'] != '' ? $array['img'] : 'https://hobbies.in-news.id/upload/avatar.png',
            'username'         => $username,
            'uid_fcm'         => $array['uf'],
            'password_user'  => $array['ps'],
            'latitude'  => $array['lat'],
