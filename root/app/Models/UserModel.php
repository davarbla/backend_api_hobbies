...
class UserModel extends Model
{
    ...
    'date_created', 'date_updated', 'height','weight','age','position','protection','relationship','bodyColor','bodyShape','hair','publish','vip','superAdmin','public','friends','fun','face','lat','lng','message', 'reliable' ];
