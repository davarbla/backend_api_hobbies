...
class CategoryModel extends Model
{
    ...
    protected $allowedFields = ['title', 'description', 'image', 'subscribe_fcm', 'total_interest', 'total_post', 'total_like', 'flag', 'status','id_category_up','group','private', 'latitude','location','fun','id_owner'];
