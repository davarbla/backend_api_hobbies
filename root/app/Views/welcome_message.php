...
<body>
    ...
    <header>
        ...
        <div class="menu">
            <ul>
                <li class="logo"><a href="https://codeigniter.com" target="_blank"><img height="44"
                            title="CodeIgniter Logo" alt="Visit CodeIgniter.com official website!"
        ...
        <div class="heroe">
            ...
            <h2>Hobbies - Find your hobbies. Together.</h2>
