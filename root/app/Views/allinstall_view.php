                    ...
                    <div class="card-body">
                        ...
                        <nav class="d-none d-md-block" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">All Installed</li>
                            </ol>
                        </nav>
                        <!-- End Breadcrumb -->

                        <div class="mb-3 mb-md-4 d-flex justify-content-between">
                            <div class="h3 mb-0">Install</div>
                        </div>
                            ...
                            <table class="table text-nowrap mb-0" id="table1">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="font-weight-semi-bold border-top-0 py-2">UUID</th>
