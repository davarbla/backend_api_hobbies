<?php 
    //print_r($_SESSION['sess_login_hobbies']);
    $dataSess = $_SESSION['sess_login_hobbies'];
    //print_r($dataSess['user']);
?>
<!-- Header -->
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown mx-3 dropdown ml-2">
                    <a id="profileMenuInvoker" class="header-complex-invoker" href="#" aria-controls="profileMenu"
                        ...
                        <span
                            class="mr-md-2 avatar-placeholder"><?php echo strtoupper(substr($dataSess['fullname_ss'], 0, 1));?></span>
                        <span class="d-none d-md-block"><?php echo $dataSess['fullname_ss'];?></span>
